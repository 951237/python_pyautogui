...
time.sleep(0.5)
print('1번째 체크박스 클릭')
pa.click(x=1169, y=354, interval=v_interval, pause=0.5) #첫번째 체크박스 클릭
print('2번째 체크박스 클릭')
pa.click(x=1169, y=724, interval=v_interval) #두번째 체크박스 클릭
...
print('객실을 선택합니다.')
pa.click(x=703, y=217, interval=0.03, pause=0.5) #객식 '선택'클릭
pa.click(x=703, y=233, interval=0.03) #객실 ' 1개 ' 선택
# pa.click(x=570, y=168, interval=0.03) #객실 ' 1개 ' 선택

print('숙박인원을 입력합니다.')
pa.click(x=571, y=295, interval=0.1) #숙박인원 선택
pa.typewrite('4', interval=0.1)
pa.click(x=625, y=475, interval=0.03) #핸드폰 번호 입력 좌표 이동
...
print('직위를 입력합니다.')
pa.click(x=586, y=550, interval=0.03) #직위 입력 좌표로 이동
pa.typewrite('1', interval=0.03)
