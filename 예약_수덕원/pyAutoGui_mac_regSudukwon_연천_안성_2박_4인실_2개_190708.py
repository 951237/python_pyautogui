...
print('객실을 선택합니다.')
pa.click(room['4a'], interval=v_interval, pause=v_pause) #객실유형 선택(4인, 8인, 4인침대)
pa.click(room['4a2'], interval=v_interval, pause = v_pause) #객실 ' 1개 ' 선택

print('숙박을 선택합니다.')
pa.click(stay['1'], interval=v_interval, pause=v_pause) # 1박을 클
pa.click(stay['2a'], interval=v_interval, pause=v_pause) # 2박을 선택
...
print('직위를 입력합니다.')
pa.typewrite('rytk', interval=v_interval)
