...
print('새로고침')
pa.click(etc['re'], interval=v_interval, pause=5) #오늘 날짜 클
...
#
# print('날짜 클릭')
# pa.click(etc['today'], interval=v_interval, pause=1.5) #오늘 날짜 클
#
# print('여백 클릭') #스크롤 방지
...
#
# print('숙박인원을 입력합니다.')
# pa.click(etc['person'], interval=v_interval, pause=v_pause) #숙박인원 선택
# pa.typewrite('4', interval=0.1)
# pa.click(etc['phone'], interval=v_interval, pause=v_pause) #핸드폰 번호 입력 좌표 이동
#
# print('핸드폰 번호를 입력합니다.')
